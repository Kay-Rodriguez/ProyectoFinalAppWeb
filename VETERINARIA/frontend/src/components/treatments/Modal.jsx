    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center z-50">
            ...
            <div className="lg:w-2xl bg-gray-700 top-1/4 left-auto fixed sticky-0 rounded-lg overflow-y-scroll">
                ...
                <p className="text-white font-bold text-lg text-center mt-4">afiliados </p>

                <form className="p-10" onSubmit={handleSubmit(registerTreatmentsForm)}>
                    <div>
                        <label className="mb-2 block text-sm font-semibold text-gray-50">Nombre del afiliado</label>
                        <input
                            type="text"
